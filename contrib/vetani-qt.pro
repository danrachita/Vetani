...
RESOURCES += src/qt/vetani.qrc src/qt/vetani_locale.qrc

TRANSLATIONS += src/qt/locale/vetani_bg.ts \
                src/qt/locale/vetani_de.ts \
                src/qt/locale/vetani_en.ts \
                src/qt/locale/vetani_es.ts \
                src/qt/locale/vetani_fi.ts \
                src/qt/locale/vetani_fr.ts \
                src/qt/locale/vetani_it.ts \
                src/qt/locale/vetani_ja.ts \
                src/qt/locale/vetani_pl.ts \
                src/qt/locale/vetani_pt.ts \
                src/qt/locale/vetani_ru.ts \
                src/qt/locale/vetani_sk.ts \
                src/qt/locale/vetani_sv.ts \
                src/qt/locale/vetani_vi.ts \
                src/qt/locale/vetani_zh_CN.ts \
                src/qt/locale/vetani_zh_TW.ts
