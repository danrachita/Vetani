...
#if defined(NDEBUG)
#error "Vetani cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Vetani Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 2700 ) {
	        nSubsidy = 1 * COIN;
	} else if( nHeight > 2700 && nHeight <= 7000 ) {
	        nSubsidy = 60 * COIN;
	} else if( nHeight > 7000 && nHeight <= 14000 ) {
	        nSubsidy = 130 * COIN;
	} else if( nHeight > 14000 && nHeight <= 28000 ) {
	        nSubsidy = 240 * COIN;
	} else if( nHeight > 28000 && nHeight <= 400000 ) {
	        nSubsidy = 130 * COIN;
