...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Vetani Core vetani-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vetani-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vetani transaction") + "\n" +
                               "  vetani-tx [options] -create [commands]   " + _("Create hex-encoded vetani transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vetani transaction
