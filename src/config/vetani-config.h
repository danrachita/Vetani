/* src/config/vetani-config.h.  Generated from vetani-config.h.in by configure.  */
/* src/config/vetani-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://vetani.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Vetani Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Vetani Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vetani"
