...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VET features */
        {"vetani", "masternode", &masternode, true, true, false},
        {"vetani", "masternodelist", &masternodelist, true, true, false},
        {"vetani", "mnbudget", &mnbudget, true, true, false},
        {"vetani", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"vetani", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vetani", "mnsync", &mnsync, true, true, false},
        {"vetani", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"vetani", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vetanid, or the -server option to vetani-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Vetani Alert\" admin@foo.com\n"),
...
{
    return "> vetani-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:38222/\n";
}
