                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Vetani-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Vetani address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vetani: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Vetani Core"), this);
    aboutAction->setStatusTip(tr("Show information about Vetani Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Vetani"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Vetani addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Vetani addresses"));
    ...
    openAction->setStatusTip(tr("Open a Vetani: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Vetani Core help message to get a list with possible Vetani command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Vetani Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vetani network", "", count));
}
...
{
    QString strTitle = tr("Vetani Core"); // default title
